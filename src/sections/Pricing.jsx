    ...
    <section>
        <Element name="pricing">
            <div className="container">
                <div className="max-w-1000 pricing-head_before pt-28 relative mx-auto border-l border-r border-s2 bg-s1/50 pb-40 pt28 max-xl:max-w-4xl max-lg:border-none max-md:pb-32 max-md:pt-16">
                    ...
                    <button className={clsx('pricing-head_btn', !monthly && "text-p4")} onClick={() => setMonthly(false)}>Anual</button>
                        ...
                        <div key={plan.id} className="pricing-plan_first pricing-plan_last pricing-plan_odd pricing-plan_even relative border-2 p-7 max-xl:min-w-80 max-lg:rounded-3xl xl:w-[calc(33.33%+2px)]">
                            ...
                            <div className={clsx('absolute left-0 right-0 z-2 flex items-center justify-center', index === 1 ? "-top-6" : "-top-6 xl:-top-11")}>
                                   <img 
                                           src={plan.logo}
                                           alt={plan.title}
                                           className={clsx('object-contain drop-shadow-2xl cursor-pointer', index === 1 ? "size-[120px]" : "size-[88px]")}
